...
const Page1 = () => {
  ...
  const fetchUserData = async (showLoading = true) => {
    ...
    try {
      const response = await fetch('http://localhost:3001/api/pharmacies/myinfo', {
        method: 'GET',
        headers: {
    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-emerald-50">
        ...
        >
          <div className="lg:block hidden">
            <div className="sticky top-6">
              <Side_bar color={'emerald'} />
            </div>
          </div>
          <div className="min-w-0">
            <Middle_part themeColor={'emerald'} userData={userData} />
          </div>
          <div className="lg:block hidden">
            <div className="sticky top-6">
              <Right_part />
        ...
        <div className="lg:hidden fixed bottom-4 left-4 right-4">
          <div className="bg-white/80 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl shadow-emerald-500/10 p-4">
            <div className="flex justify-between items-center">
              <button className="flex flex-col items-center space-y-1 p-2 rounded-xl hover:bg-emerald-50 transition-colors">
