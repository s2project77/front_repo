...
<section  className="py-16 bg-green-50">
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="p-8">
            <h3 className="text-2xl font-semibold mb-4 text-center">New here?</h3>
            <p className="text-gray-600 mb-6 text-center">Register for easy access to pharmacy details and more.</p>
            ...
            <Link href="/regestration" className="block w-full py-3 px-4 bg-green-600 text-white rounded-md text-center font-medium hover:bg-green-700 transition">
              Register Now
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          <div className="p-8">
            <h3 className="text-2xl font-semibold mb-4 text-center">Already a member?</h3>
            <p className="text-gray-600 mb-6 text-center">Log in to manage your preferences and find pharmacies faster!</p>
