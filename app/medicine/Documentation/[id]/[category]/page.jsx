                        ...
                        <>
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 w-full max-w-6xl mx-auto">
                                {visible.map((brandName, index) => (
                                    <div className="bg-white h-60 hover:shadow-2xl flex flex-col p-4 border border-blue-200 rounded-lg transition-all duration-300 shadow-lg hover:border-blue-400" key={index}>
                                        ...
                                        <div className="flex justify-center w-full mt-4">
                                            <Link href={`/Documentation`}>
                                                <button className="px-4 py-2 w-full bg-gradient-to-r from-blue-400 to-blue-500 text-white font-medium rounded-lg shadow-md hover:from-blue-500 hover:to-blue-600 transform hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-300">
                                                    View Documentation
                                                </button>
                                            </Link>
                                        </div>
