...
export default function Navbar() {
 ...
 <div className="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center text-white mr-2">
        ...
        <Link href={"/"} >  <span className="text-xl font-bold text-green-800">MediFind</span>
        </Link>
 </div>
...
{Navbar_data.map((data)=>
 ...
 <div className='w-[6cm] justify-center items-center mx-auto text-center flex flex-row gap-4  ' ><Link href={"/regestration"}>your profile</Link>
